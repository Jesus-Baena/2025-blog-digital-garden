 ...
 * How to Add New Software:
   * Install it: sudo pacman -S new-app
   * Update your list: update-pkgs
   * Back it up: lazydots, stage the pkglist files, commit, and push.
 * How to Add a New Webapp:
   * Create the webapp in your browser.
   * Back it up: lazydots, stage the new .desktop file, commit, and push.
